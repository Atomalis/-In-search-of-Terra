...
public class IsotPlanets{
        ...
        caereleum = new Planet("caereleum", Planets.sun, 12f) {{
            ...
            arlord = new Planet("arlord", caereleum, 1f, 2) {{
            ...
            hiddenItems.addAll(Items.erekirItems).addAll(Items.serpuloItems).removeAll(IsotItems.snewerusItems);
